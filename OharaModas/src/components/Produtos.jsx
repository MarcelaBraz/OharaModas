...
function Produtos() {
  const produtos = [
    ...
    { id: 20, nome: 'Boné Luffy Gear 5', preco: 'R$ 59,90', imagem: 'https://photos.enjoei.com.br/vestido-longo-vinho-floral-95267120/800x800/czM6Ly9waG90b3MuZW5qb2VpLmNvbS5ici9wcm9kdWN0cy8yODk3NTEwNS8yZTFhYzUwNjA5YTM4NWQ2ODIwOTk3Njg5MDEzNmNhNy5qcGc' }
  ];
